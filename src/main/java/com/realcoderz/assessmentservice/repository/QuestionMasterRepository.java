...
//    
    ...
    @Query(nativeQuery = true, value = "select qm.question_id,qm.question_type_id,qm.question_desc,qm.coding_template,qm.no_of_answer,qm.language_id from assessment_question rcq,question_master qm where rcq.assessment_id=?1 and qm.question_id=rcq.question_id")
