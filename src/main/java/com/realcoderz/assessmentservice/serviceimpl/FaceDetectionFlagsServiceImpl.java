...
public class FaceDetectionFlagsServiceImpl implements FaceDetectionFlagsService {
    ...
    public Map<String, Object> addFaceDetectionFlags(Map map) {
        ...
        try {
            ...
            ex.printStackTrace();
            logger.error("problem FaceDetectionFlagsServiceImpl :: addFaceDetectionFlags()  Exception occurred !" + ex);
        }
        logger.info("FaceDetectionFlagsServiceImpl :: addFaceDetectionFlags() => Response data " + resultMap);
